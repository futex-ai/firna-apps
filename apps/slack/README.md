...
The webhook ingress forwards only `x-slack-request-timestamp` and
`x-slack-signature`, preserving their raw bytes and rejecting missing,
malformed, or duplicate signature inputs.
